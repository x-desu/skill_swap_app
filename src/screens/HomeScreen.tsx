...
import { View, Text, StyleSheet, Dimensions, TouchableOpacity, Animated, PanResponder, useColorScheme } from 'react-native';
    ...
    if (currentIndex >= users.length) {
        return (
            <View style={[styles.container, styles.center, { backgroundColor: colors.background }]}>
                ...
                <Text style={[styles.subText, { color: colorScheme === 'dark' ? '#aaa' : '#666' }]}>Check back later for new skills.</Text>
            </View>
        );
    }
...
const styles = StyleSheet.create({
    container: { flex: 1 }, // Removed background color here to manage dynamically
