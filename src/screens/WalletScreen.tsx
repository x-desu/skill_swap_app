...
export default function WalletScreen() {
    ...
    return (
        <ScrollView style={[styles.container, { paddingTop: insets.top, backgroundColor: colors.background }]}>
            ...
            <View style={[styles.card, { backgroundColor: colorScheme === 'dark' ? '#1E1E1E' : '#333' }]}>
            ...
            <View style={styles.transaction}>
                <View style={[styles.iconBox, { backgroundColor: colorScheme === 'dark' ? '#1a3320' : '#E8F5E9' }]}>
            ...
            <View style={styles.transaction}>
                <View style={[styles.iconBox, { backgroundColor: colorScheme === 'dark' ? '#332020' : '#FFEBEE' }]}>
            ...
            <View style={styles.transaction}>
                <View style={[styles.iconBox, { backgroundColor: colorScheme === 'dark' ? '#1a2833' : '#E3F2FD' }]}>
